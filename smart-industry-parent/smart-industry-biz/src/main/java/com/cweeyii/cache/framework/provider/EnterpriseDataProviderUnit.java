...
@Service
public class EnterpriseDataProviderUnit extends AbstractDataProviderUnit<Long, EnterpriseRichnessView> {

    private static final Logger LOGGER = LoggerFactory.getLogger(EnterpriseDataProviderUnit.class);
